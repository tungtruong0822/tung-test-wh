...
export class SensorListExtension extends UIBaseExtension {
    ...
    async load() {
        ...
        this.panel = new SensorListPanel(this.viewer, 'iot-sensor-list', 'Khối lượng bê tông', {});
    ...
    onToolbarCreated() {
        this.createToolbarButton('iot-sensor-list-btn', 'Export to Excel', 'https://img.icons8.com/ios-filled/50/000000/ms-excel.png');
    }
}